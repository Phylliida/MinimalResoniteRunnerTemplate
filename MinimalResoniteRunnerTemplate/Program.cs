...
namespace MinimalResoniteRunnerTemplate
{
    ...
    public class FrooxEngineRunner
    {
        ...
        {
            string settingsLocation = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "TessaCoil", "MinimalResoniteRunnerTemplate", "app.config");
        ...
        public FrooxEngineRunner()
        {
            ...
            Delegate initWorldDelegate = 
                ...
                delegate (object world)
                {
                    ...
                    SetProperty(world, "Name", "MinimalResoniteRunnerTemplate");
                    CallMethod(world, "AddSlot", "MinimalResoniteRunnerTemplateSlotRoot");
                });
